...
@interface RNTPDF () <IDocEventListener, UIExtensionsManagerDelegate>
@end

@implementation RNTPDF
{
  FSPDFViewCtrl* pdfViewCtrl;
  UIExtensionsManager* extensionsManager;
  NSString* _password;
  NSDictionary* _extensionConfig;
  BOOL* _enableBottomToolbar;
  BOOL* _enableTopToolbar;
...
{
  if ( _extensionConfig != NULL) {
    NSData* configData = [NSJSONSerialization dataWithJSONObject:_extensionConfig                                                         options:NSJSONWritingPrettyPrinted error: nil];
...
- (void) setEnableBottomToolbar: (BOOL *) enableBottomToolbar
{
  _enableBottomToolbar = enableBottomToolbar;
  
  if (_enableBottomToolbar != NULL) {
    [extensionsManager enableBottomToolbar:_enableBottomToolbar];
  }
...
- (void) setEnableTopToolbar: (BOOL *) enableTopToolbar
{
  ...
  if (_enableTopToolbar != NULL) {
    [extensionsManager enableTopToolbar:_enableTopToolbar];
  }
}
...
- (void) setExtensionConfig: (NSDictionary *) extensionConfig
{
  _extensionConfig = @{
